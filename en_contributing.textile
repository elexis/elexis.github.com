...
The "Elexis bootstrap project":https://github.com/ngiger/bootstrap-elexis-3 is used by "Jenkins":http://www.jenkins-ci.org continuos integration to build an elexis version after each check-in in one of several repositories where you can find the Elexis core and most of the OpenSource plugins.
