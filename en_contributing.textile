...
Elexis is a community effort, and we welcome all contributors.  Here's your chance to get involved and help your fellow developers.
...
The release manager also maintains a ChangeLog for each repository and branch.
...
In the future we will probably also use github "issue tracker":https://github.com/elexis/elexis/issues
...
"Our community Wiki":https://github.com/elexis/elexis/wiki/_pages.
...
The "Elexis bootstrap project":https://bitbucket.org/ngiger/elexis-bootstrap is used by at least two different "Jenkins":http://www.jenkins-ci.org continuos integration to build an elexis version after each check-in in one of several repositories where you can find the Elexis core and most of the OpenSource plugins.

The central repository is "Elexis base":http://hg.code.sf.net/p/elexis/elexis-base which contains the core of Elexis and many additional plug-ins. There you find a plug-in **ch.elexis.developer.resources**, which teaches you how to program with Elexis. Start reading the file `doc/developer.textile`.
...
The care and feeding of the "CI Jobs":http://ngiger.dyndns.org/jenkins/ is the responsibility of the committers.
